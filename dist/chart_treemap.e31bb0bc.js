...
.range(d3.schemeDark2.map(function (c) {
  ...
  return c;
    ...
    treemap = d3.treemap().size([width, height]).tile(d3.treemapSquarify //.ratio(1)
...
cells //.style("transform", function(d) { return "translateY(" + chart.node().clientHeight * y(d.y0) / 100 + ")"; })
...
cells.append('p').attr('class', 'label').text(function (d) {
  return d.data.name ? d.data.name : 'null';
});
var parent = d3.select('.logo').datum(nodes).on('click', zoom); // can't resquarify as we use 100*100% treemap size. Doh!
...
function zoom(d) {
  ...
  cells.transition(t).style('left', function (d) {
    return nearest(x(d.x0), snap) + '%';
  }).style('top', function (d) {
    return nearest(y(d.y0), snap) + '%';
  }).style('width', function (d) {
  ...
  }).classed('hide', false); // if currentDepth == 3 show prev/next buttons
}
...
function showPath(p) {
  var path = d3.select('.breadcrumb').selectAll('a').data(p.map(function (d) {
    return d;
  }).reverse());
  path.exit().remove();
  path.enter().append('a').attr('href', '#').html(function (d) {
    return d.data.name;
  }).on('click', zoom);
}
...
},{"d3":"node_modules/d3/index.js","./style.scss":"style.scss"}],"../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{"./bundle-url":"../.config/yarn/global/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../.config/yarn/global/node_modules/parcel-bundler/src/builtins/loaders/browser/css-loader.js":[function(require,module,exports) {
...
var b=require("../.config/yarn/global/node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("css",require("../.config/yarn/global/node_modules/parcel-bundler/src/builtins/loaders/browser/css-loader.js"));b.load([]).then(function(){require("index.js");});
},{}]},{},["../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js",0], null)
//# sourceMappingURL=/chart_treemap.e31bb0bc.js.map